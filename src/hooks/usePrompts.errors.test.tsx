...
import { usePrompts, useTags, useTopCreators } from "./usePrompts";
...
describe("query failure and recovery", () => {
  afterEach(cleanup);
  it.each([usePrompts, useTags, useTopCreators])("reports failure and recovers to a genuine empty result in %s", async (hook) => {
    let failed = true;
    const builder = {
